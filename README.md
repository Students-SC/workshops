<p style="text-align: center;">
    <picture>
        <source media="(prefers-color-scheme: dark)" srcset="./static/sc25_dark.png">
        <source media="(prefers-color-scheme: light)" srcset="./static/sc25.png">
        <img alt="SC25 Logo" src="./static/sc25.png" style="width: 100%; max-width: 400px;">
    </picture>
</p>

This site contains supplemental materials for the Resume and Portfolio Workshops.

## Resume Workshop

- **Time:** 9:00AM - 9:45AM
- **Room:** 263
- **Instructor:** Marisol Gamboa, Lawrence Livermore National Laboratory (LLNL)
...
- **Room:** 263
- **Instructor:** Will Killian, NVIDIA Corporation
